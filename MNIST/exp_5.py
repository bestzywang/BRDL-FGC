r"""Exp 3:
- The codes are used to plot Fig. 7 (a) in the paper.
"""
...
if not args.plot:
    ...
    g.set(xlim=(0, MAX_BATCHES_PER_EPOCH * EPOCHS), ylim=(0, 100))
    g.set_axis_labels("Iterations", "Accuracy (%)")
    g.set_titles(row_template=r"$|B| = {row_name}$", col_template=r"$\rho = {col_name}$")
    g.fig.subplots_adjust(wspace=0.1)

    g.fig.savefig(OUT_DIR + "exp31.pdf", bbox_inches="tight", dpi=720)
